...
- For libraries it's a good way to reduce maintenance cost.
  ...
  - If you have strict rules about documenting supported by linters, you could save tme and not documenting internal things, linters respect leading underscore.
...
Couple of simple rules:
 ...
 - when you need to make it public, thin if you really need it, and do it. This is a really simple refactoring that touches a single file.
